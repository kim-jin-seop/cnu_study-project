...
public class alone extends FragmentActivity implements OnMapReadyCallback,
...
//                button.setText("원하는 곳에서 꾹눌러주세요");
                ...
                mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
                    public void onMapLongClick(LatLng latLng) {
                        ...
                        Intent intent = new android.content.Intent(getApplicationContext(), add_alone.class);
