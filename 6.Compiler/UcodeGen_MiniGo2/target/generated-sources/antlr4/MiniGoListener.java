...
public interface MiniGoListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MiniGoParser#print_stmt}.
	 * @param ctx the parse tree
	 */
	void enterPrint_stmt(MiniGoParser.Print_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniGoParser#print_stmt}.
	 * @param ctx the parse tree
	 */
	void exitPrint_stmt(MiniGoParser.Print_stmtContext ctx);
	/**
